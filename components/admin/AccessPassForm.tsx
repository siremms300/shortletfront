// components/admin/AccessPassForm.tsx
'use client';
...
interface AccessPassFormProps {
  booking: Booking;
  onSend: (formData: { accessCode: string; provider: string; instructions: string }) => void;
  onUpdate: (formData: { accessCode: string; provider: string; instructions: string }) => void;
  onCancel: () => void;
  loading: boolean;
}

export default function AccessPassForm({ booking, onSend, onUpdate, onCancel, loading }: AccessPassFormProps) {
